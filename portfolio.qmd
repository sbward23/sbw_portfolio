...
1.  **Ward, S. B.**, Hassanpour, P., Walsh, K. (2023). Process-based consent among college men: The interactive influence of hostility toward women, perceived peer norms, and alcohol-involved sexual consent attitudes. *Under Review, the submitted manuscript is available in pdf format [at this link](https://github.com/sbward23/sbw_portfolio/blob/main/materials/My%20Papers/Ward%20et%20al.%2C%20submission%20-%20sex%20roles.pdf).*
    -   Registration DOI (anonymized view-only link for masked peer review): <https://osf.io/zxrjp/?view_only=89295c61cb5f415c9f9526df9352d517> 
...
-   PDF of slide deck can be accessed here.

#### Posters

*\*\*Mentored presentation by an undergraduate mentee.*

1.  **\*\*Does Anxiety Moderate the Effect of Peer Drinking Norms on Past-Month Alcohol-Induced Blackouts? An Observational Study Among College Students.** April 17, 2024.
...
2.  **\*\*Associations Between Lifetime Sexual Violence and Engaging in Choking During Sex: Findings from an Undergraduate Sample.** November 15, 2023.
...
5.  **Sexual Consent Among College Men: The Moderating Effects of Alcohol-Involved Sex and Hostility Toward Women.** November 5, 2022.\
    \
...
6.  **Associations between Sexual Assault History and Sexual Consent Feelings and Behaviors among College Students: A Path Model Involving Alcohol Use Prior to Sex & Emotion Dysregulation.** November 18, 2021.
...
7.  **\*\*Sexual Assault Resistance Strategies, Blame, and Mental Health Outcomes.** November 4, 2021.
...
8.  **Sexual Assault Victimization and Perpetration among those Involved in Greek Life and Varsity Athletics: A Large National Study.** November 19, 2020.
...
Described in the Teaching and Mentorship sections below.

## Clinical Experiences

### Theoretical Orientation Statement

My theoretical orientation is rooted in the cognitive-behavioral tradition. Third-wave principles guide my approach to case conceptualization and intervention, which strives to be holistic in nature by considering the context of an individual's experience. The central concepts, process-based focus, and philosophical assumptions of the third wave ground my practice in science while enabling integration and flexibility.

Third-wave methods highlight the role of mindfulness, acceptance, emotions, values, and meta‐cognition. Each of these constructs has an extensive knowledge base that connects their role in wellbeing and treatment to empirically supported mechanisms of change. In my practice, I prioritize pathways to change over strict adherence to disorder-specific protocols because I have seen this approach benefit my patients.

Specifically, I use a bottom-up approach to conceptualization that considers a patient\'s symptoms in the context of their goals, history, culture, strengths, and the domains they identify as most critically impacted. Doing so prevents me from using their symptoms to make a diagnosis and then building a conceptualization and treatment plan around that disorder, a flawed strategy given the high rate of comorbidity among diagnostic categories originally theorized to have distinct etiologies. In contrast, my conceptualization illuminates transdiagnostic processes of change consistent with a patient\'s presentation and the dimensional nature of psychopathology. Centering core processes means conceptualizations and treatment plans can be more readily tailored to a patient\'s needs as they evolve throughout therapy.

However, flexibility does not mean I readily abandon evidence-based protocols whenever a patient wants to switch gears...
...
prtc_summ <- data.frame(
  Summary = c("Intervention", "Assessment", "Total Direct", "Supervision"),
  Hours = c("173.75", "63.50", "237.25", "151.50"))
# format table
kable(uhs_summ, booktabs = TRUE, align = 'lr', col.names = c("Summary", "Hours")) %>%
  kable_styling(full_width = FALSE)
```
...
De-identified, integrated assessment reports are linked below.

1\. [17M](https://github.com/sbward23/sbw_portfolio/blob/main/materials/de-identified%20reports/17M_ASPD.pdf) - diagnostic and personality assessment to evaluate for suspected ASPD.

2\. [29M](https://github.com/sbward23/sbw_portfolio/blob/main/materials/de-identified%20reports/29M_ADHD.pdf) - neuropsychological assessment for ADHD in an adult with high intelligence.

3\. [39M](https://github.com/sbward23/sbw_portfolio/blob/main/materials/de-identified%20reports/39M_PDD.pdf) - diagnostic and personality assessment for an adult with life-long depression.

4\. [18F](https://github.com/sbward23/sbw_portfolio/blob/main/documents/de-identified%20reports/de-identified_18F_BN.docx) - therapy intake and assessment to confirm diagnosis of bulimia nervosa.

5\. 22F - Integrated report on cPTSD case cross-listed under DEI, please see below.
...
I study sexual violence, the burden of which is inequitably distributed. Racialized and other minoritized groups are disproportionately impacted by sexual violence and the risk of victimization is compounded among those with multiple marginalized identities. I promote equity through sexual violence research by investigating the nature of these disparities and facilitating efforts to eliminate them. Producing rigorous, high-quality science in this area of study requires cultural humility, awareness of subjectivity, and recognition of racist, patriarchal power structures, because the assertion that complex psychosocial experiences can be understood through objective scientific approaches ignores history and context, perpetuating inequity.
...
...In diagnosing and treating an especially complex case of PTSD, I have also grown my cultural awareness, competency, and humility. My work with this particular patient has been highly impactful, reinforcing my desire to provide mental health services to women and veterans holding several intersecting identities that shape how they experience psychopathology. I am eager to diversify my caseload in a more heterogeneous population and would welcome the chance to assess and treat housing-insecure and justice-impacted individuals as well as patients with multiple comorbid conditions.

### DEI Training Record

#### Case Conceptualization

The integrated intake assessment report, including case conceptualization and treatment plan, for a patient with intersecting marginalized identities is accessible [here](https://github.com/sbward23/sbw_portfolio/blob/main/documents/de-identified%20reports/de-identified_22F_cPTSD.docx).
